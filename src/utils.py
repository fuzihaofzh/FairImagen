"""Utility functions for entropy and mutual information calculations.

Provides information-theoretic measures used in fairness analysis:
- Entropy estimation using k-nearest neighbors
- Mutual information between variables
- Gaussian entropy calculations
"""
...
def mutual_information(variables, k=1):
    ...
    """
    if len(variables) < 2:
        msg = "Mutual information must involve at least 2 variables"
